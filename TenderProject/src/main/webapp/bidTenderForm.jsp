<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.sql.*,com.sgm.dao.VendorDao,com.sgm.dao.VendorDaoImpl, java.util.Date,com.sgm.beans.TenderBean,com.sgm.dao.TenderDao,com.sgm.dao.TenderDaoImpl,com.sgm.utility.DBUtil,javax.servlet.annotation.WebServlet,com.sgm.beans.VendorBean" errorPage="errorpage.jsp"%>
