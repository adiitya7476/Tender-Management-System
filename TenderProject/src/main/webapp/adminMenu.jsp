      ...
      <div id="collapsable-nav" class="collapse navbar-collapse hidden-lg hidden-md">
        <ul id="nav-list" class="nav navbar-nav navbar-left pull-left">
            ...
            <li class="dropdown">
               ...
               <li class="dropdown">
                <a class="dropdown-toggle " data-toggle="dropdown" data-animations="fadeIn fadeInLeft fadeInUp fadeInRight" data-hover="dropdown">Reports
                    <span class="caret"></span></a>   
                <ul class="dropdown-menu">
                  <li><a href="vendorReports.jsp">Vendors</a></li>
                  <li><a href="tenderReports.jsp">Tenders</a></li>
                  <li><a href="noticeReports.jsp">Notice</a></li>
                  <li><a href="TenderStatusReports.jsp">Tender Status</a></li>
                </ul>
              </li>
             <li>
