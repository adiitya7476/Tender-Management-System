<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.sql.*, java.lang.Integer,com.sgm.beans.NoticeBean,com.sgm.utility.DBUtil,java.util.List,java.util.ArrayList,com.sgm.dao.NoticeDaoImpl,com.sgm.dao.NoticeDao, javax.servlet.annotation.WebServlet" errorPage="errorpage.jsp"%>
