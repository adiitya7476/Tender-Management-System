<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import="java.sql.*,com.sgm.beans.NoticeBean,com.sgm.utility.DBUtil,com.sgm.dao.NoticeDao,com.sgm.dao.NoticeDaoImpl,javax.servlet.annotation.WebServlet" errorPage="errorpage.jsp"%>
