...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        &nbsp; <span id="goal">Our Goal</span></h4>
        <div class="marquee-content" style="align:center; padding-top:10px; padding-left: 20px; min-height:750px;background-color:cyan">
     		<h3>At Big-Bid, we are driven by a singular mission: to redefine and 
     		simplify the tender management process.</h3>
     	<ul>
   			<h2>Streamlining Tender Management:</h2>
   			<li><h3>Eliminate complexities and time-consuming tasks associated with procurement.</h3></li>
     	</ul>
      </div>
     </div>
     </div>
